...
$(document).ready(function () {
  ...
  //   "aaSorting": [[1, "desc"]],
  //   "columnDefs": [
  //     { "bSortable": false, "aTargets": [0, 2, 3, 4, 5, 7, 8] },
  ...
  //     { data: 'cost', class: "total_sale text-right" },
  //     { data: 'total_amount', class: "total_sale text-right" },
  //     { data: 'profit', class: "total_sale text-right" },
  //     { data: 'button' },
  //   ],
  ...
  //         }, 0);
  //       $(this.footer())
  //         .html(currency + ' ' + sum.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }));
  //     });
  //   }
  ...
  /*
  var invoiceHistory = $('#invoice_history').DataTable({
    responsive: true,
    ...
    'serverMethod': 'post',
    'ajax': {
      'url': base_url + 'invoice/invoice/check_invoice_history',
      "data": function (data) {
        data.fromdate = $('#from_date').val();
        data.todate = $('#to_date').val();
        data.csrf_test_name = csrf_test_name;
  ...
  $('#btn-filter').click(function () {
    console.log('example');
    invoiceHistory.ajax.reload();
  });
*/

  /*
    var invoiceTrash = $('#invoice_trash').DataTable({
      responsive: true,
      ...
      'serverMethod': 'post',
      'ajax': {
        'url': base_url + 'invoice/invoice/check_invoice_trash',
        "data": function (data) {
          data.fromdate = $('#from_date').val();
          data.todate = $('#to_date').val();
          data.csrf_test_name = csrf_test_name;
  ...
  */
  ...
  /*
  var invoicedatatable = $('#low_stock_products_table').DataTable({
    responsive: true,
    searching: false,
    "bSort": false,
    'processing': true,
    ...
    'serverMethod': 'post',
    'ajax': {
      'url': base_url + 'dashboard/home/low_stock_products_list',
    },
    'columns': [
      { data: 'product' },
      { data: 'stock' },
  ...
  // LOW Stock Availability DATATABLE

  var invoicedatatable = $('#stock_availability_table').DataTable({
    responsive: true,
    searching: false,
    "bSort": false,
    'processing': true,
    ...
    'serverMethod': 'post',
    'ajax': {
      'url': base_url + 'product/product/bdtask_stock_availability_list',
    },
    'columns': [
      { data: 'sl' },
      { data: 'product_name' },
...
$(document).ready(function () {
  ...
  //Filterable Reports
  // $('#filterStockReport').DataTable({
  //   "ajax": {
  //     'url': base_url + 'report/report/filterable_reports',
  //     type: 'GET'
  //   },
  // });
  ...
  // var checkListStockList = $('#checkListStockList').DataTable({
  //   // responsive: true,

  //   "aaSorting": [[1, "asc"], [5, "asc"], [6, "asc"], [7, "asc"], [8, "asc"]],
  //   "columnDefs": [
  //     { "bSortable": false, "aTargets": [0, 2, 3, 4, 9] },
  ...
  //   checkListStockList.ajax.reload();
  // });
...
$(document).ready(function () {
  ...
  var mydatatable = $('#supplierList').DataTable({
    ...
    'lengthMenu': [[10, 25, 50, 100, 250, 500, 1000], [10, 25, 50, 100, 250, 500, "All"]],
