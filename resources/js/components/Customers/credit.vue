<template>
    <div>
        <ol class="breadcrumb">
            ...
            <li class="active">Credit Customers</li>
        </ol>
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4 class="d-inline-block">Manage Credit Customers</h4>
...
export default {
    ...
    methods: {
        getCustomers() {
            axios.get('api/customers/?creditCustomers').then(({ data }) => (this.customers = data.data));
        },
        async destroy(id) {
